...
- [x] fix latched state in InternetMonitor (PR #4) — link rows, banner and status word were edge-triggered and stuck; bound rows to measures, added a banner arbiter with an explicit clear branch; verified against the live feed across all four states
